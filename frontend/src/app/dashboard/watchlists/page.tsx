...
export default function WatchlistsPage() {
  ...
  return (
    <div className="flex h-full">
      ...
      <div className={`w-full md:w-[280px] shrink-0 border-r border-gray-100 flex flex-col bg-white ${selectedId ? "hidden md:flex" : "flex"}`}>
      ...
      <div className={`flex-1 overflow-y-auto ${selectedId ? "block" : "hidden md:block"}`}>
        {!selected ? (
          ...
          <div className="flex flex-col h-full">
            <div className="px-4 md:px-8 py-5 border-b border-gray-100">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="md:hidden p-1 -ml-1 text-gray-400 hover:text-gray-600 transition"
                >
                  <ArrowLeft size={18} />
                </button>
                <h1 className="text-lg md:text-xl font-bold text-gray-900">Edit Watchlist</h1>
              </div>
            ...
            {/* Bottom bar */}
            <div className="px-4 md:px-8 py-4 border-t border-gray-100 flex items-center justify-end gap-3">
              <button
          ...
          /* ─── Detail View ─── */
          <div className="flex flex-col h-full">
            <div className="px-4 md:px-8 py-5 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <button
                ...
                <h1 className="text-lg md:text-xl font-bold text-gray-900">{selected.watchlistName}</h1>
                <button
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-[calc(100vw-2rem)] max-w-[400px] p-6">
      ...
      {showAlertModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-[calc(100vw-2rem)] max-w-[500px] p-6">
