"""
AI Prompts for Verification System
Imported from main application's src/ai/prompts.py
"""
...
4.  If the PDF contains tables, **recreate them using proper Markdown table syntax**:
    -   Use `|` for column separators
    -   Use `---` under headers
    -   Align columns appropriately
5.  Write like a human would write Markdown for GitHub or Obsidian — no escaping characters, no quoting or code formatting, just raw readable Markdown.
6.  Do not include escaped characters like `\\n`, `\\|`, or code block syntax.
7.  The output should be **clean, copy-paste ready** for any Markdown editor and visually well-formatted.
8.  Ensure the summary covers all key details, metrics, and actions mentioned in the PDF.
9.  Maintain clear formatting and layout for easy readability and professional presentation.
...
sentiment_prompt = """
Analyze the sentiment of the announcement and give appropriate output. The output should be only: Positive, Negative or Neutral. Nothing other than these.
"""
